...
import com.example.mynotepad.asrfinishjson.AsrFinishJsonData;
import com.example.mynotepad.asrpartialjson.AsrPartialJsonData;
 ...
 */
public class NotesList extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> ,EventListener{
    ...
    private String[] dataColumns = { NotePad.Notes.COLUMN_NAME_TITLE ,NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE,NotePad.Notes.COLUMN_BACKGROUND_COLOR,
            NotePad.Notes.COLUMN_TEXT_COLOR} ;

    // The view IDs that will display the cursor columns, initialized to the TextView in
    // noteslist_item.xml
     private int[] viewIDs = { R.id.text1,R.id.time};
...
//            Log.d(TAG, "Temp Params:"+params);
    ...
    private void start() {
       ...
       // btnStartRecord.setEnabled(false);
        ...
        params.put(SpeechConstant.PID, 1537); // 默认1537
        ...
        if(desc !=null && desc.equals("Speech Recognize success.")){
            ...
            if(final_result.equals("")){
                ...
                updatecursor = getContentResolver().query(
                        getIntent().getData(),
                        PROJECTION,
                        NotePad.Notes.COLUMN_NAME_TITLE+" GLOB '*"+final_result+"*'",
                        null,
                        NotePad.Notes.DEFAULT_SORT_ORDER
                );
            }
            ...
            System.out.println("解析错误,原因是:" + desc + "\n" + errorResult);
        }
    }
